...
<form method="POST" class="form" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="titulo_primario">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Titulo secundario</label>
    <input type="text" class="form-control" name="titulo_secundario">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">qtd quartos</label>
    <input type="text" class="form-control" name="qtd_quartos">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">qtd banheiros</label>
    <input type="text" class="form-control" name="qtd_banheiros">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">opcionais</label>
    <input type="text" class="form-control" name="opcionais">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">qtd hospedes</label>
    <input type="text" class="form-control" name="qtd_hospedes">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">valor diaria</label>
    <input type="text" class="form-control" name="valor_diaria">
  </div>
  <div class="form-group">
